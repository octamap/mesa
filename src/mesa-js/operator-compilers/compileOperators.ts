...
export default async function compileOperators(
    htmlText: string,
    variables: Variable[]
) {
...
function getCodeBrackets(htmlText: string): Array<{ content: string, startIndex: number, endIndex: number }> {
...
function compileIfOperators(doc: Document) {
