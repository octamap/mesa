...
export default function forOperatorCompile(htmlText, variables) {
 ...
 */
export function repeatElement(dom, element, items, itemVar, indexVar) {
    const output = [];
 ...
 */
function walkTextNodes(dom, parent, transform) {
...
export function compileVariables(code, baseName, variables, wrapStrings) {
    ...
    return code.replace(regex, (_match, capture) => {
